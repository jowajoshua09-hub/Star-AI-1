...
async def main():
    ...
    # Clear webhook with retries – fixes "Conflict" error
    for attempt in range(5):
        ...
        logger.error("Could not delete webhook after 5 attempts. Continuing anyway.")

    # Give Telegram time to process the deletion
